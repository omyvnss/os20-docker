...
OS20 is a local-first, open-source CRM. No cloud. No login. No authentication. Just run one command and get a full CRM dashboard.
...
The lead-enrichment core in `services/os20-leadgen` is derived from the
MIT-licensed [Scout](https://github.com/kiryano/Scout) project.
