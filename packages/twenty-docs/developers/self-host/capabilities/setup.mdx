...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](/developers/self-host/capabilities/docker-compose) to get OS20 running, then return here for configuration.
</Warning>

OS20 offers **two configuration modes** to suit different deployment needs:
...
1. Access your OS20 instance (usually `http://localhost:3010`)
