...
const LeadGeneration = lazy(() =>
  import('~/pages/lead-generation/LeadGeneration').then(
    (module) => ({
...
const WebAgents = lazy(() =>
  import('~/pages/settings/web-agents/WebAgentsSettings').then(
    (module) => ({
...
export const SettingsRoutes = ({ isAdminPageEnabled }: SettingsRoutesProps) => (
  <Suspense fallback={<SettingsSkeletonLoader />}>
    <Routes>
      ...
      <Route path={SettingsPath.AIProviders} element={
        <SettingsProtectedRouteWrapper settingsPermission={PermissionFlagType.WORKSPACE}>
          <SettingsAIProviders />
        </SettingsProtectedRouteWrapper>
      } />

      <Route path={SettingsPath.LeadGeneration} element={
        <SettingsProtectedRouteWrapper settingsPermission={PermissionFlagType.WORKSPACE}>
          <LeadGeneration />
        </SettingsProtectedRouteWrapper>
      } />

      <Route path={SettingsPath.WebAgents} element={
        <SettingsProtectedRouteWrapper settingsPermission={PermissionFlagType.WORKSPACE}>
          <WebAgents />
        </SettingsProtectedRouteWrapper>
      } />

      <Route path={SettingsPath.WebSearchApis} element={
        <SettingsProtectedRouteWrapper settingsPermission={PermissionFlagType.WORKSPACE}>
          <WebSearchApis />
        </SettingsProtectedRouteWrapper>
      } />
