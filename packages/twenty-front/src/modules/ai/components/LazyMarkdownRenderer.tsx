...
const MARKDOWN_COMPONENTS = {
  ...
  // A remote image would load as soon as the reply renders, which a scraped
  // page could use to leak data through the URL. Show a link instead.
  img: ({ src, alt }: { src?: string; alt?: string }) => {
    const safeUrl = typeof src === 'string' ? getSafeUrl(src) : undefined;
