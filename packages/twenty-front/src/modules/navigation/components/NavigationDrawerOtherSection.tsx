...
import { IconHelpCircle, IconSettings, IconRobot, IconMessageCirclePlus } from 'twenty-ui/icon';
  ...
  return (
    <NavigationDrawerSection>
      ...
      >
        ...
        />
        <NavigationDrawerItem
          label={t`Lead Generation`}
          to={SettingsPath.LeadGeneration}
          Icon={IconMessageCirclePlus}
        />
        <NavigationDrawerItem
          label={t`Web Agents`}
          to={SettingsPath.WebAgents}
          Icon={IconRobot}
        />
      </AnimatedExpandableContainer>
    </NavigationDrawerSection>
