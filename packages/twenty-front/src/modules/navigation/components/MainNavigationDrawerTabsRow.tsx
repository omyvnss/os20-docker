...
const isNavigationMenuTabActive =
  ...
  const isWorkflowsTabActive =
    navigationDrawerActiveTab === NAVIGATION_DRAWER_TABS.WORKFLOWS;
    ...
    <StyledRow isExpanded={isExpanded}>
      <NavigationDrawerAnimatedCollapseWrapper>
        <StyledTabsPill role="tablist" aria-label={t`Navigation tabs`}>
          ...
          <StyledTabWrapper
            isActive={isWorkflowsTabActive}
            role="tab"
            aria-selected={isWorkflowsTabActive}
            aria-label={t`Workflows`}
            tabIndex={isWorkflowsTabActive ? 0 : -1}
            onClick={handleTabClick(NAVIGATION_DRAWER_TABS.WORKFLOWS)}
            onKeyDown={handleTabKeyDown(NAVIGATION_DRAWER_TABS.WORKFLOWS)}
          >
            <StyledTabIcon>
              <IconGitBranch
                size={theme.icon.size.md}
                color={getTabIconColor(isWorkflowsTabActive)}
              />
            </StyledTabIcon>
          </StyledTabWrapper>
          <StyledTabWrapper
            isActive={isAiChatTabActive}
            role="tab"
            aria-selected={isAiChatTabActive}
            aria-label={t`AI Chat`}
            tabIndex={isAiChatTabActive ? 0 : -1}
          ...
          >
            <StyledTabIcon>
              <IconComment
                size={theme.icon.size.md}
                color={getTabIconColor(isAiChatTabActive)}
              />
            </StyledTabIcon>
          </StyledTabWrapper>
          <StyledNewChatIcon>
