...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'os20.git11.xyz',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'os20.git11.xyz', label: 'OS20' }],
      },
      {
        primaryLinkUrl: 'github.com/twentyhq/twenty',
        primaryLinkLabel: 'OS20 Repo',
        secondaryLinks: [{ url: 'os20.git11.xyz', label: '' }],
      },
      {
