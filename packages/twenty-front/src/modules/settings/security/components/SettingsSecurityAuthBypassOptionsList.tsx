      ...
      <Card rounded>
        {authProviders.google === true && (
          <SettingsOptionCardContentToggle
            Icon={IconGoogle}
            title={t`Google`}
            description={t`Allow Google-based access for users with SSO bypass permissions.`}
        ...
        {authProviders.microsoft === true && (
          <SettingsOptionCardContentToggle
            Icon={IconMicrosoft}
            title={t`Microsoft`}
            description={t`Allow Microsoft-based access for users with SSO bypass permissions.`}
        ...
        {authProviders.password && (
          <SettingsOptionCardContentToggle
            Icon={IconPassword}
            title={t`Password`}
            description={t`Allow email & password access for SSO bypass users.`}
