          ...
          <Card rounded>
            {authProviders.google === true && (
              <SettingsOptionCardContentToggle
                Icon={IconGoogle}
                title={t`Google`}
                description={t`Allow access through Google's single sign-on functionality.`}
            ...
            {authProviders.microsoft === true && (
              <SettingsOptionCardContentToggle
                Icon={IconMicrosoft}
                title={t`Microsoft`}
                description={t`Allow access through Microsoft's single sign-on functionality.`}
            ...
            {authProviders.password === true && (
              <SettingsOptionCardContentToggle
                Icon={IconPassword}
                title={t`Password`}
                description={t`Allow users to authenticate with an email and password.`}
