...
import { Os20WriteOutreachCommandButton } from '@/os20-contacts/components/Os20WriteOutreachCommandButton';
...
const StyledOs20ActionsBar = styled.div`
...
const StyledRecordLayout = styled.div`
  flex: 1;
  min-height: 0;
`;
          ...
          <StyledSidePanelRecord hasDeletedRecordBanner={!!recordDeletedAt}>
            ...
            >
              {objectNameSingular === CoreObjectNameSingular.Person && (
                <StyledOs20ActionsBar>
                  <Os20WriteOutreachCommandButton personId={objectRecordId} />
                </StyledOs20ActionsBar>
              )}
              <StyledRecordLayout>
