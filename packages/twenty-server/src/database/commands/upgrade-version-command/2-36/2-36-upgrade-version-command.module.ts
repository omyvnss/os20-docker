...
import { AddPersonLeadFieldsCommand } from 'src/database/commands/upgrade-version-command/2-36/2-36-workspace-command-1787950000000-add-person-lead-fields.command';
