...
export class AiModelRegistryService {
  ...
  validateModelAvailability(
    ...
    // behind the workspace enabled/recommended list. Auto-select still needs at
    // least one enabled model to resolve a concrete default.
  ...
  // ponytail: merges per-workspace keys at resolve time; recreate-on-each-call
