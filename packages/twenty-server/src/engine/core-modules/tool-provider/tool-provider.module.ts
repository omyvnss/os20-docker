...
import { LeadGenerationModule } from 'src/engine/core-modules/lead-generation/lead-generation.module';
import { FindLeadsToolProvider } from 'src/engine/core-modules/lead-generation/tools/find-leads-tool.provider';
import { WebAgentToolProvider } from 'src/engine/core-modules/web-agent/web-agent-tool.provider';
import { WebSearchApisModule } from 'src/engine/core-modules/web-search-apis/web-search-api.module';
import { WebSearchToolProvider } from 'src/engine/core-modules/web-search-apis/providers/web-search-tool.provider';
import { WebScrapeToolProvider } from 'src/engine/core-modules/web-search-apis/providers/web-scrape-tool.provider';
...
@Module({
  ...
  providers: [
    ...
    WebScrapeToolProvider,
    FindLeadsToolProvider,
    WorkflowToolProvider,
    {
      ...
      useFactory: (
        ...
        webAgentProvider: WebAgentToolProvider,
        webSearchProvider: WebSearchToolProvider,
        webScrapeProvider: WebScrapeToolProvider,
        findLeadsProvider: FindLeadsToolProvider,
