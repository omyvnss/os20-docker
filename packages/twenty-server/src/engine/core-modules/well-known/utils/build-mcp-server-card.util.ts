...
export const buildMcpServerCard = ({
  ...
  title: 'OS20 CRM',
  description:
    'Read and write your OS20 CRM data - companies, people, opportunities, tasks, notes and any custom objects - from AI assistants. Tools are discovered at runtime and scoped to the authenticated workspace.',
  websiteUrl: 'https://os20.git11.xyz',
  repository: {
    url: 'https://github.com/omyvnss/os20',
    source: 'github',
  },
  remotes: [
    {
