...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  emailStatus: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      label: i18nLabel(
        msg({ message: `Email Status`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `How the contact's email was obtained or checked`,
          context: 'fieldMetadata.description',
        }),
      ),
      icon: 'IconMailCheck',
      ...
      options: [
        {
          id: '20202020-db16-4937-b9d2-1786e3a8a0ea',
          value: 'FOUND',
          label: i18nLabel(
            msg({ message: `Found`, context: 'fieldMetadata.label' }),
          ),
          position: 0,
          color: 'blue',
        },
        {
          id: '20202020-abff-4cc0-826e-83a392c2b495',
          value: 'GUESSED',
          label: i18nLabel(
            msg({ message: `Guessed`, context: 'fieldMetadata.label' }),
          ),
          position: 1,
          color: 'orange',
        },
        {
          id: '20202020-a805-4ce5-bed7-5b6c59176f33',
          value: 'VERIFIED',
          label: i18nLabel(
            msg({ message: `Verified`, context: 'fieldMetadata.label' }),
          ),
          position: 2,
          color: 'green',
        },
        {
          id: '20202020-ec1a-421d-b78a-ad7f2ac6bb02',
          value: 'INVALID',
          label: i18nLabel(
            msg({ message: `Invalid`, context: 'fieldMetadata.label' }),
          ),
          position: 3,
          color: 'red',
        },
  ...
  leadSource: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.TEXT,
      label: i18nLabel(
        msg({ message: `Lead Source`, context: 'fieldMetadata.label' }),
      ),
      description: i18nLabel(
        msg({
          message: `Where the contact was found`,
          context: 'fieldMetadata.description',
        }),
      ),
