...
import { Os20EmailModule } from 'src/engine/core-modules/os20-email/os20-email.module';
import { Os20UpdatesModule } from 'src/engine/core-modules/os20-updates/os20-updates.module';
...
export class AppModule {
  private static getConditionalModules(): DynamicModule[] {
    ...
    // The landing/marketing site is hosted separately (Lovable) and is NOT
    // served here. Opening the root path (`/`) shows the CRM dashboard.
